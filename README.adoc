...
Start from the xref:https://luisarizmendi.github.io/workshop-object-detection-rhde/modules/00-intro.html[*Lab Introduction*] and then choose your role... or try all of them if time allows!
...
clone + script to change repo references + what to change (ie. lab intro, how to deploy the lab)?
