= Object Detection with Red Hat Device Edge
...
Start from the xref:https://luisarizmendi.github.io/workshop-object-detection/modules/00-intro.html[*Lab Introduction*] and then choose your role... or try all of them if time allows!
