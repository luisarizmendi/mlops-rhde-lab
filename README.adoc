...
Start from the xref:https://luisarizmendi.github.io/workshop-object-detection-rhde/modules/00-intro.html[*Lab Details*] and then choose your role... or try all of them if time allows!
...
This repository contains the workshop guide, solutions and deployment scripts, you won't need to change anything on it since the Workshop guide will ask you to create your own empty repositories to complete the steps, but if you want to build your own workshop based on this one you will need to clone this repo, and then perform the required changes in the Architecture and Lab Details pages and the `antora.yml` file variables based on your setup. You will find more information about it in the xref:https://luisarizmendi.github.io/workshop-object-detection-rhde/modules/00-how_to_deploy_lab.html[Deployment Guide].
