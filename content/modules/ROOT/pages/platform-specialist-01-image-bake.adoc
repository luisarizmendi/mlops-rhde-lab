...
[[registry]]
location = "YOUR-GITEA-CONTAINER-IMAGE-REGISTRY"
insecure = true
EOF
bootc switch --mutate-in-place --transport registry YOUR-GITEA-CONTAINER-IMAGE-REGISTRY/YOUR-GROUP-NUMBER/nvidia:0.0.2
%end
