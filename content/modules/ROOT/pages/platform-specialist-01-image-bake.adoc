...
[source,toml,role=execute,subs="attributes"]
----
...
....
[[registry]]
location = "{git-workshop-url}"
insecure = true
EOF
bootc switch --mutate-in-place --transport registry {git-workshop-url}/YOUR-GROUP-NUMBER/nvidia:0.0.2
%end
