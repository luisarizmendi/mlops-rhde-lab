...
To install this on a machine called A, make sure that you have sudo / passwordless access to A and add machine A to the inventory file.
...
Then install and configure Gitea on A using the playbook provided: 
