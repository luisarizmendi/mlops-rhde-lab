...
4- Deploy the Actuator. It needs also to use the host network. Also you will need to include the backend route. Please, don't forget the `/alert` and `/alive` as part of the environment variable value.
