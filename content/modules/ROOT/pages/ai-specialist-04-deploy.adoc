...
You have deployed the Cloud-side applications, now use your own laptop to run the rest of the applications:
...
3. Deploy the Actuator. It needs also to use the host network. Also you will need to include 
...
==== The convinient but not-that-edgy test architecture
