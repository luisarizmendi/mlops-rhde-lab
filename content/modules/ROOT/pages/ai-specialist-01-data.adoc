...
[TIP]
====
If you encounter issues while cloning images or prefer to save time, you can simply Fork the following dataset:

https://universe.roboflow.com/luisarizmendi/hardhat-or-hat

Forking typically results in fewer issues than cloning in Roboflow. Even if an error appears, the images will still be copied to your account.

After cloning, ensure you remove any images that don't belong to the hardhat or no_hardhat classes. To remove unwanted images:
