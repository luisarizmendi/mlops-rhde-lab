...
In order to clone a subset of images in a Dataset you have to:
...
After cloning be sure that you remove images with other classes than `hardhat` or `no_hardhat`
