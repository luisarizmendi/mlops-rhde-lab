...
* *Object Detectio*n: Identifies and localizes objects within an image.
...
* *c*: Held out until the end, this subset provides an unbiased evaluation of the model's generalization to unseen data. It typically comprises 10-20% of the total dataset.
