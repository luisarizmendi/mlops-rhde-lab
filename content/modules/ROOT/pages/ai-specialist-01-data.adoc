...
Sometimes cloning the images with the required labels makes more sense than forking the entire Dataset, including images that are not relevant to our use case.
