...
Once downloaded, you can uncompress the zip file and take a look at the file structure for `YOLOv11` format. You will see the images in three different directories and YAML and TXT files.
...
If you open the YAML file you will see the Dataset metadata, including the class names
