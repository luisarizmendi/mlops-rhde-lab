...
git remote set-url origin http://{gitea-user-base}<span id="gnumberVal"></span>:{gitea-password-base}<span id="gnumberVal"></span>@{gitea-server}/user<span id="gnumberVal"></span>/user<span id="gnumberVal"></span>-ai.git
git add .
