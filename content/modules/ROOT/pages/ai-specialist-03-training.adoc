...
# Convert DetMetrics to a string (e.g., by using its __str__ method or relevant attribute)
results_train_str = str(results_train)

# Save the string representation of the object to the file, overwriting it each time
with open(results_train_save_path, "w") as f:  
    f.write(f"{results_train_str}\n")



results_test_save_path = "model_train_results"

# Convert DetMetrics to a string (e.g., by using its __str__ method or relevant attribute)
results_test_str = str(results_test)

# Save the string representation of the object to the file, overwriting it each time
with open(results_test_save_path, "w") as f:  
    f.write(f"{results_test_str}\n")
...
try:
    with open(results_train_save_path, "r") as file:
        results_train_new = file.read().strip()
...
try:
    with open(results_test_save_path, "r") as file:
        results_test_new = file.read().strip()
except FileNotFoundError:
