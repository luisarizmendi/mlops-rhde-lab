...
Login to the shared lab OpenShift {openshift-console}[cluster] using the provided username and password {openshift-user-base}pass:[<span id="gnumberVal"></span>]:{openshift-password-base}pass:[<span id="gnumberVal"></span>] from your Workstation. 
