...
Make sure you have installed `oc` and `helm` cli on your own machine. You can find them here https://console-openshift-console.apps.pass:[<span id="cdomainVal"></span>] /command-line-tools

Login to the shared lab OpenShift https://console-openshift-console.apps.pass:[<span id="cdomainVal"></span>] [cluster] using the provided username and password {openshift-user-base}:{openshift-password-base}. 
