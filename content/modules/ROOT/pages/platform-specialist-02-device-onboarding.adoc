...
$ helm upgrade --install --version=0.4.0 \
    --namespace userpass:[<span id="gnumberVal"></span>] --create-namespace \
...
----
$ oc get pods -n userpass:[<span id="gnumberVal"></span>]
...
----
FROM {container-registry-gitea}/pass:[<span id="gnumberVal"></span>]/nvidia:0.0.2
...
----
$ sudo podman build -t {container-registry-gitea}/pass:[<span id="gnumberVal"></span>]/nvidia:0.0.2 .
----
...
----
$ sudo podman push <image-id> {container-registry-gitea}/pass:[<span id="gnumberVal"></span>]/nvidia:0.0.2
----
