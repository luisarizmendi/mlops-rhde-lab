...
* Web Console URL: link:https://console-openshift-console.apps.[<span id="cdomainVal"></span>][OpenShift Console]
* Web Console URL: pass:attributes[https://console-openshift-console.apps.<span id="cdomainVal"></span>]
* Web Console URL: pass:[<a href="https://console-openshift-console.apps.<span id="cdomainVal"></span>">OpenShift Console</a>]





* Web Console URL: pass:[https://console-openshift-console.apps.<span id="cdomainVal"></span>]
* API URL: pass:[https://api.<span id="cdomainVal"></span>:6443] 
