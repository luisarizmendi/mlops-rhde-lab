...
* IT Platform Specialist: Assists in monitoring and automating the application.

* OT Specialist: Configures the Alarm Management System and ensures proper integration with existing plant operations.
...
Now that you have background you need to act as an active member of one of the team groups that have been created to provide a working solution for the challenge. This will be like reading a "choose your own adventure" book, you can choose to play as one of the following roles:  

* AI Specialist / MLOps Engineer
* APP Developer / DevOps Engineer
* Platform Specialist  / Site Reliability Engineer (SRE)

Each role will provide an exectial piece of the overall solution. The AI Specialist will create and maintain the AI model, the APP Developers will do the same thing for the applications that will use that model, and the Platform specialist will be the ones that will make sure that the app+model is deployed and working properly in the provided devices.

Pick your choice or play as all of them if you have time!
