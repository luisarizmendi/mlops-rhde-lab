...
2- Create a new Data Science Project "userpass:[<span id="gnumberVal"></span>]-ai-prototyping"
...
7- Create a `userpass:[<span id="gnumberVal"></span>]-ai-prototyping.ipynb` file on the cloned directory
====
