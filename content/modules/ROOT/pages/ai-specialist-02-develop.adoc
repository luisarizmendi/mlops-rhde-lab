...
podman run --privileged -p 8800:8800 quay.io/luisarizmendi/object-detection-model-test:latest



takes time to start, it will be ready when:
...
IMPORTAT: drag-and-drop does nto work with chrome




ai-build-test-app.png
