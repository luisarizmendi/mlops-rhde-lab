...
To visually test the performance of your object detection model, you can download the model's best.pt file from Object Storage. Then, utilize the following containerized application to perform the test locally: https://github.com/luisarizmendi/workshop-object-detection-rhde/blob/main/resources/solutions/ai-specialist/development/model_test_app/object-detection-batch.py[object-detection-batch.py]. This script allows you to seamlessly integrate the model and run the performance evaluation directly on your local machine.

[source,python,role=execute,subs="attributes"]
----
podman run -p 8800:8800 quay.io/luisarizmendi/object-detection-model-test:latest
----
