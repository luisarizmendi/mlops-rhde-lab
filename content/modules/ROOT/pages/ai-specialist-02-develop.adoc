...
1. Navigate to "Data Science Pipelines" in OpenShift AI and add a new pipeline server.
2. Import the data connection information, but update the bucket to userpass:[<span id="gnumberVal"></span>]-ai-pipelines and set the region to none (as it is not configured in MinIO).
3. Save the configuration.
4. Restart any running workbenches to apply the updates.
====
