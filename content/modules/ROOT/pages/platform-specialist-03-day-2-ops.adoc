...
* {container-registry-gitea}/{container-registry-gitea-user}/object-detection-stream-manager:v1
* {container-registry-gitea}/{container-registry-gitea-user}/object-detection-inference-server:v1
* {container-registry-gitea}/{container-registry-gitea-user}/object-detection-action:v1
